...
**Unfortunately this tool didn't make it into this release due to some incompatibilities with the current gvSIG Nasa Worldwind plugin version. We are working on it, time permitting.**
...
image::images/gpserver_client_01.png[]
